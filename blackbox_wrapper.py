...
class BlackboxWrapper(object):
    ...
    Parameters
    ----------
    blackbox : trained model that takes a dataset as input and outputs labels
    input_dimensions: int
        number of dimensions of the input data for the model (2 or 3)
    output_dimensions: int
        number of dimensions of the output labels of the model (1 or 2)
        1: [batch] or [batch,1], 2: [batch, n_classes]
